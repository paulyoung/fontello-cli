...
(function() {
  var HOST, apiRequest, fontello, fs, needle, open, path, print, unzipper;
    ...
    install: function(options) {
      return apiRequest(options, function(sessionUrl) {
        ...
        if (options.css && options.font) {
          return zipFile.pipe(unzipper.Parse()).on('entry', (function(entry) {
          ...
          return zipFile.pipe(unzipper.Extract({
            path: '.'
          })).on('finish', (function() {
            return print('Install complete.\n'.green);
          }));
